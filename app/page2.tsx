      ...
      <section className="relative h-[600px] w-full overflow-hidden">
        ...
        <div className="container relative z-20 flex h-full flex-col items-center justify-center text-center text-white">
          ...
          <p className="mb-8 max-w-2xl text-lg sm:text-xl">
            Đồng hành cùng học sinh phát triển kỹ năng STEM, Robotics và các kỹ
            năng thiết yếu cho công dân toàn cầu
          </p>
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
          <Link href="/lien-he">
            <Button size="lg" className="bg-[#40C262] hover:bg-[#024AAE] text-base">
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-[#024AAE] sm:text-4xl">
            Về chúng tôi
            </h2>
            <p className="mx-auto max-w-3xl text-muted-foreground">
              Công ty TNHH Tư vấn và Đào tạo Giáo dục Sài Gòn là đơn vị tiên
              phong trong lĩnh vực đào tạo STEM, Robotics và kỹ năng sống cho
              học sinh các cấp.
            </p>
          </div>
          <FadeInSection vertical={false} xOffset={-20} delay={0.3}>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              <Card className="border-t-4 border-t-[#40C262]">
                ...
                <CardContent className="text-center">
                  <p>
                    ...
                    thông qua các dự án STEM thực tế.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-[#024AAE]">
                ...
                <CardContent className="text-center">
                  <p>
                    Học lập trình và điều khiển robot, phát triển tư duy logic
              ...
              <Card className="border-t-4 border-t-[#40C262]">
                ...
                <CardContent className="text-center">
                  <p>
                    Trang bị kiến thức và kỹ năng cần thiết để trở thành công
                    dân số có trách nhiệm trong kỷ nguyên số.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-[#024AAE]">
                ...
                <CardContent className="text-center">
                  <p>
                    Phát triển các kỹ năng thiết yếu như giao tiếp, làm việc
                    nhóm, tự phục vụ và quản lý cảm xúc.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-3xl text-muted-foreground">
              Khám phá các chương trình đào tạo đa dạng, được thiết kế phù hợp
              với từng độ tuổi và nhu cầu học tập
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {featuredPrograms.map((program, index) => (
              <Card key={index} className="overflow-hidden">
                ...
                <CardFooter>
                  <Link
                    href={`/chuong-trinh-dao-tao/${program.slug}`}
                    className="w-full"
                  >
          ...
          <div className="mt-12 text-center">
            <Link href="/chuong-trinh-dao-tao">
              <Button
                variant="outline"
                className="border-[#40C262] text-[#40C262] hover:bg-[#40C262] hover:text-white"
              >
        ...
        <div className="container">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div className="flex flex-col justify-center text-white">
              ...
              Quý đối tác, nhà trường hoặc phụ huynh quan tâm có thể liên hệ với chúng tôi để cùng tạo nên giá trị giáo dục bền vững.
              </p>
